...
m.def("argmax", [](const PyAnyTorchTensorValue &self, const PyAnyTorchOptionalIntValue &dim, const PyTorch_BoolValue &keepdim) { return argmax(self, dim, keepdim); }, "self"_a, "dim"_a = py::none(), "keepdim"_a = false);
...
m.def("bincount", [](const PyAnyTorchTensorValue &self, const PyAnyTorchOptionalTensorValue &weights, const PyTorch_IntValue &minlength) { return bincount(self, weights, minlength); }, "self"_a, "weights"_a = py::none(), "minlength"_a = 0);
...
m.def("layer_norm", [](const PyAnyTorchTensorValue &input, const PyAnyTorchListOfTorchIntValue &normalized_shape, const PyAnyTorchOptionalTensorValue &weight, const PyAnyTorchOptionalTensorValue &bias, const PyTorch_FloatValue &eps, const PyTorch_BoolValue &cudnn_enable) { return layer_norm(input, normalized_shape, weight, bias, eps, cudnn_enable); }, "input"_a, "normalized_shape"_a, "weight"_a = py::none(), "bias"_a = py::none(), "eps"_a = 1.0000000000000001e-05, "cudnn_enable"_a = true);
...
m.def("norm", [](const PyAnyTorchTensorValue &self, const PyAnyTorchOptionalScalarValue &p, const PyAnyTorchListOfTorchIntValue &dim, const PyTorch_BoolValue &keepdim) { return norm(self, p, dim, keepdim); }, "self"_a, "p"_a = py::none(), "dim"_a, "keepdim"_a = false);
...
m.def("slice", [](const PyAnyTorchTensorValue &self, const PyTorch_IntValue &dim, const PyAnyTorchOptionalIntValue &start, const PyAnyTorchOptionalIntValue &end, const PyTorch_IntValue &step) { return slice(self, dim, start, end, step); }, "self"_a, "dim"_a = 0, "start"_a = py::none(), "end"_a = py::none(), "step"_a = 1);

// aten::slice_copy.Tensor : (Tensor, int, int?, int?, int) -> (Tensor)
m.def("slice_copy", [](const PyAnyTorchTensorValue &self, const PyTorch_IntValue &dim, const PyAnyTorchOptionalIntValue &start, const PyAnyTorchOptionalIntValue &end, const PyTorch_IntValue &step) { return slice_copy(self, dim, start, end, step); }, "self"_a, "dim"_a = 0, "start"_a = py::none(), "end"_a = py::none(), "step"_a = 1);

// aten::slice_scatter : (Tensor, Tensor, int, int?, int?, int) -> (Tensor)
m.def("slice_scatter", [](const PyAnyTorchTensorValue &self, const PyAnyTorchTensorValue &src, const PyTorch_IntValue &dim, const PyAnyTorchOptionalIntValue &start, const PyAnyTorchOptionalIntValue &end, const PyTorch_IntValue &step) { return slice_scatter(self, src, dim, start, end, step); }, "self"_a, "src"_a, "dim"_a = 0, "start"_a = py::none(), "end"_a = py::none(), "step"_a = 1);
...
m.def("tensor", [](const PyAnyTorchListValue &data, const PyAnyTorchOptionalIntValue &dtype, const PyAnyTorchOptionalDeviceValue &device, const PyTorch_BoolValue &requires_grad) { return tensor(data, dtype, device, requires_grad); }, "data"_a, "dtype"_a = py::none(), "device"_a = py::none(), "requires_grad"_a = false);

// aten::tensor.bool : (bool, int?, Device?, bool) -> (Tensor)
m.def("tensor", [](const PyTorch_BoolValue &t, const PyAnyTorchOptionalIntValue &dtype, const PyAnyTorchOptionalDeviceValue &device, const PyTorch_BoolValue &requires_grad) { return tensor(t, dtype, device, requires_grad); }, "t"_a, "dtype"_a = py::none(), "device"_a = py::none(), "requires_grad"_a = false);

// aten::tensor.int : (int, int?, Device?, bool) -> (Tensor)
m.def("tensor", [](const PyTorch_IntValue &t, const PyAnyTorchOptionalIntValue &dtype, const PyAnyTorchOptionalDeviceValue &device, const PyTorch_BoolValue &requires_grad) { return tensor(t, dtype, device, requires_grad); }, "t"_a, "dtype"_a = py::none(), "device"_a = py::none(), "requires_grad"_a = false);

// aten::tensor.float : (float, int?, Device?, bool) -> (Tensor)
m.def("tensor", [](const PyTorch_FloatValue &t, const PyAnyTorchOptionalIntValue &dtype, const PyAnyTorchOptionalDeviceValue &device, const PyTorch_BoolValue &requires_grad) { return tensor(t, dtype, device, requires_grad); }, "t"_a, "dtype"_a = py::none(), "device"_a = py::none(), "requires_grad"_a = false);
