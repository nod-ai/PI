...
conv_transpose1d = shark.conv_transpose1d

# conv_transpose2d = shark.conv_transpose2d

# conv_transpose3d = shark.conv_transpose3d

# conv_tbc = shark.conv_tbc

# Pooling
# avg_pool1d = shark.avg_pool1d

avg_pool2d = shark._nn.avg_pool2d


# avg_pool3d = shark._C._nn.avg_pool3d
...
def fractional_max_pool2d_with_indices(
    ...
    if _random_samples is None:
        ...
        _random_samples = shark.rand(
            n_batch, input.size(-3), 2, dtype=input.dtype, device=input.device
        )
    return shark._C._nn.fractional_max_pool2d(
...
def fractional_max_pool3d_with_indices(
    ...
    return shark._C._nn.fractional_max_pool3d(
        input, kernel_size, output_size, _random_samples
    )
...
def max_pool1d_with_indices(
    ...
    if stride is None:
        stride = shark.jit.annotate(List[int], [])
    return shark.max_pool1d_with_indices(
...
def _max_pool1d(
    ...
    if stride is None:
        stride = shark.jit.annotate(List[int], [])
    return shark.max_pool1d(input, kernel_size, stride, padding, dilation, ceil_mode)
...
def max_pool2d_with_indices(
    ...
    return shark._nn.max_pool2d_with_indices(
        input, kernel_size, stride, padding, dilation, ceil_mode
    )
...
def _max_pool2d(
    ...
    return shark.max_pool2d(input, kernel_size, stride, padding, dilation, ceil_mode)
...
def max_pool3d_with_indices(
    ...
    return shark._C._nn.max_pool3d_with_indices(
        input, kernel_size, stride, padding, dilation, ceil_mode
    )
...
def _max_pool3d(
    ...
    if stride is None:
        stride = shark.jit.annotate(List[int], [])
    return shark.max_pool3d(input, kernel_size, stride, padding, dilation, ceil_mode)
...
def _unpool_output_size(
    ...
    default_size = shark.jit.annotate(List[int], [])
...
def max_unpool1d(
    ...
    if isinstance(output_size, list):
        ...
        output_size = output_size + (1,)
    return shark._C._nn.max_unpool2d(
...
def max_unpool2d(
    ...
    output_size = _unpool_output_size(input, kernel_size, _stride, padding, output_size)
    return shark._C._nn.max_unpool2d(input, indices, output_size)
...
def max_unpool3d(
    ...
    output_size = _unpool_output_size(input, kernel_size, _stride, padding, output_size)
    return shark._C._nn.max_unpool3d(input, indices, output_size, _stride, padding)
...
def lp_pool2d(
    ...
    return (shark.sign(out) * relu(shark.abs(out))).mul(kw * kh).pow(1.0 / norm_type)
...
def lp_pool1d(
    ...
    return (
        (shark.sign(out) * relu(shark.abs(out))).mul(kernel_size).pow(1.0 / norm_type)
    )
...
def adaptive_max_pool1d_with_indices(
    ...
    return shark.adaptive_max_pool1d(input, output_size)
...
def adaptive_max_pool2d_with_indices(
    ...
    return shark._C._nn.adaptive_max_pool2d(input, output_size)
...
def adaptive_max_pool3d_with_indices(
    ...
    output_size = _list_with_default(output_size, input.size())
    return shark._C._nn.adaptive_max_pool3d(input, output_size)
...
# adaptive_avg_pool1d = shark.adaptive_avg_pool1d


def adaptive_avg_pool2d(input: Tensor, output_size: BroadcastingList2[int]) -> Tensor:
    _output_size = _list_with_default(output_size, input.size())
    return shark._nn.adaptive_avg_pool2d(input, _output_size)


def adaptive_avg_pool3d(input: Tensor, output_size: BroadcastingList3[int]) -> Tensor:
    _output_size = _list_with_default(output_size, input.size())
    return shark._C._nn.adaptive_avg_pool3d(input, _output_size)
...
def relu(input: Tensor, inplace: bool = False) -> Tensor:
    if inplace:
        result = shark.relu_(input)
    else:
        result = shark.relu(input)
    return result
...
def glu(input: Tensor, dim: int = -1) -> Tensor:
    ...
    return shark._C._nn.glu(input, dim)
...
def hardtanh(
    ...
    if inplace:
        result = shark._nn.hardtanh_(input, min_val, max_val)
    else:
        result = shark._nn.hardtanh(input, min_val, max_val)
    return result


hardtanh_ = shark._nn.hardtanh_


def relu6(input: Tensor, inplace: bool = False) -> Tensor:
    if inplace:
        result = shark._nn.relu6_(input)
    else:
        result = shark._nn.relu6(input)
    return result


def elu(input: Tensor, alpha: float = 1.0, inplace: bool = False) -> Tensor:
    if inplace:
        result = shark._C._nn.elu_(input, alpha)
    else:
        result = shark._C._nn.elu(input, alpha)
    return result


# elu_ = shark._C._nn.elu_


def selu(input: Tensor, inplace: bool = False) -> Tensor:
    if inplace:
        result = shark.selu_(input)
    else:
        result = shark.selu(input)
    return result
...
def celu(input: Tensor, alpha: float = 1.0, inplace: bool = False) -> Tensor:
    if inplace:
        result = shark.celu_(input, alpha)
    else:
        result = shark.celu(input, alpha)
    return result
...
def leaky_relu(
    ...
    if inplace:
        result = shark._nn.leaky_relu_(input, negative_slope)
    else:
        result = shark._nn.leaky_relu(input, negative_slope)
    return result


leaky_relu_ = shark._nn.leaky_relu_
...
def rrelu(
    ...
    if inplace:
        result = shark.rrelu_(input, lower, upper, training)
    else:
        result = shark.rrelu(input, lower, upper, training)
    return result


# rrelu_ = shark.rrelu_

# logsigmoid = shark._C._nn.log_sigmoid

gelu = shark._C._nn.gelu

# hardshrink = shark.hardshrink
...
def gumbel_softmax(
    ...
    gumbels = (
        -shark.empty_like(logits, memory_format=shark.legacy_contiguous_format)
        .exponential_()
        .log()
    )  # ~Gumbel(0,1)
    ...
    if hard:
        ...
        y_hard = shark.zeros_like(
            logits, memory_format=shark.legacy_contiguous_format
...
# softshrink = shark._C._nn.softshrink
...
def hardsigmoid(input: Tensor, inplace: bool = False) -> Tensor:
    if inplace:
        return shark._C._nn.hardsigmoid_(input)
    return shark._C._nn.hardsigmoid(input)


linear = shark._nn.linear


# bilinear = shark.bilinear


def silu(input: Tensor, inplace: bool = False) -> Tensor:
    if inplace:
        return shark._C._nn.silu_(input)
    return shark._C._nn.silu(input)


def mish(input: Tensor, inplace: bool = False) -> Tensor:
    if inplace:
        return shark._C._nn.mish_(input)
    return shark._C._nn.mish(input)


def hardswish(input: Tensor, inplace: bool = False) -> Tensor:
    if inplace:
        return shark._nn.hardswish_(input)
    return shark._nn.hardswish(input)


def _no_grad_embedding_renorm_(
    weight: Tensor, input: Tensor, max_norm: float, norm_type: float
) -> Tuple[Tensor, Tensor]:
    shark.embedding_renorm_(weight.detach(), input, max_norm, norm_type)
...
def layer_norm(
    ...
    return shark.layer_norm(input, normalized_shape, weight, bias, eps, False)
...
def group_norm(
    ...
    return shark.group_norm(
        input, num_groups, weight, bias, eps, shark.backends.cudnn.enabled
    )
...
def gaussian_nll_loss(
    ...
    # Calculate the loss
    loss = 0.5 * (shark.log(var) + (input - target) ** 2 / var)
    if full:
...
def kl_div(
    ...
    reduced = shark.kl_div(input, target, reduction_enum, log_target=log_target)
...
def cross_entropy(
    ...
    if size_average is not None or reduce is not None:
        reduction = _Reduction.legacy_get_string(size_average, reduce)
    return shark._C._nn.cross_entropy_loss(
        input,
        target,
        weight,
        _Reduction.get_enum(reduction),
...
def binary_cross_entropy(
    ...
    return shark._C._nn.binary_cross_entropy(input, target, weight, reduction_enum)
...
def binary_cross_entropy_with_logits(
    ...
    return shark.binary_cross_entropy_with_logits(
...
def smooth_l1_loss(
    ...
    expanded_input, expanded_target = shark.broadcast_tensors(input, target)
    return shark._C._nn.smooth_l1_loss(
...
def huber_loss(
    ...
    expanded_input, expanded_target = shark.broadcast_tensors(input, target)
    return shark._C._nn.huber_loss(
...
def margin_ranking_loss(
    ...
    return shark.margin_ranking_loss(input1, input2, target, margin, reduction_enum)
...
def hinge_embedding_loss(
    ...
    if size_average is not None or reduce is not None:
        ...
        reduction_enum = _Reduction.get_enum(reduction)
    return shark.hinge_embedding_loss(input, target, margin, reduction_enum)
...
def multilabel_margin_loss(
    ...
    if size_average is not None or reduce is not None:
        ...
        reduction_enum = _Reduction.get_enum(reduction)
    return shark._C._nn.multilabel_margin_loss(input, target, reduction_enum)
...
def soft_margin_loss(
    ...
    if size_average is not None or reduce is not None:
        ...
        reduction_enum = _Reduction.get_enum(reduction)
    return shark._C._nn.soft_margin_loss(input, target, reduction_enum)
...
def cosine_embedding_loss(
    ...
    if size_average is not None or reduce is not None:
        ...
        reduction_enum = _Reduction.get_enum(reduction)
    return shark.cosine_embedding_loss(input1, input2, target, margin, reduction_enum)
...
def multi_margin_loss(
    ...
    return shark._C._nn.multi_margin_loss(
        input, target, p, margin, weight, reduction_enum
    )


# pixel_shuffle = shark.pixel_shuffle

# pixel_unshuffle = shark.pixel_unshuffle

# channel_shuffle = shark.channel_shuffle

# native_channel_shuffle = shark.native_channel_shuffle
...
def interpolate(
    ...
    if recompute_scale_factor is not None and recompute_scale_factor:
        ...
        if not shark.jit.is_scripting() and shark._C._get_tracing_state():
                ...
                (
                    shark.floor(
                        (
                            ...
                            * shark.tensor(scale_factors[i], dtype=shark.float32)
                        ).float()
                    )
                )
                for i in range(dim)
    ...
    if input.dim() == 3 and mode == "nearest":
        return shark._C._nn.upsample_nearest1d(input, output_size, scale_factors)
    if input.dim() == 4 and mode == "nearest":
        return shark._C._nn.upsample_nearest2d(input, output_size, scale_factors)
    if input.dim() == 5 and mode == "nearest":
        return shark._C._nn.upsample_nearest3d(input, output_size, scale_factors)

    if input.dim() == 3 and mode == "nearest-exact":
        return shark._C._nn._upsample_nearest_exact1d(input, output_size, scale_factors)
    if input.dim() == 4 and mode == "nearest-exact":
        return shark._C._nn._upsample_nearest_exact2d(input, output_size, scale_factors)
    if input.dim() == 5 and mode == "nearest-exact":
        return shark._C._nn._upsample_nearest_exact3d(input, output_size, scale_factors)
    ...
    if input.dim() == 3 and mode == "linear":
        ...
        return shark._C._nn.upsample_linear1d(
            input, output_size, align_corners, scale_factors
        )
    if input.dim() == 4 and mode == "bilinear":
        assert align_corners is not None
        if antialias:
            return shark._C._nn._upsample_bilinear2d_aa(
                input, output_size, align_corners, scale_factors
            )
        return shark._C._nn.upsample_bilinear2d(
            input, output_size, align_corners, scale_factors
        )
    if input.dim() == 5 and mode == "trilinear":
        assert align_corners is not None
        return shark._C._nn.upsample_trilinear3d(
            input, output_size, align_corners, scale_factors
        )
    if input.dim() == 4 and mode == "bicubic":
        assert align_corners is not None
        if antialias:
            return shark._C._nn._upsample_bicubic2d_aa(
                input, output_size, align_corners, scale_factors
            )
        return shark._C._nn.upsample_bicubic2d(
            input, output_size, align_corners, scale_factors
        )
...
def grid_sample(
    ...
    return shark.grid_sampler(input, grid, mode_enum, padding_mode_enum, align_corners)
...
def affine_grid(
    ...
    return shark.affine_grid_generator(theta, size, align_corners)
...
# pairwise_distance = shark.pairwise_distance

# pdist = shark.pdist

# cosine_similarity = shark.cosine_similarity

# one_hot = shark._C._nn.one_hot
...
def triplet_margin_loss(
    ...
    if size_average is not None or reduce is not None:
        ...
        reduction_enum = _Reduction.get_enum(reduction)
    return shark.triplet_margin_loss(
...
def triplet_margin_with_distance_loss(
    ...
    *,
    ...
    if distance_function is None:
        distance_function = shark.pairwise_distance
    ...
    if swap:
        ...
        dist_neg = shark.minimum(dist_neg, dist_swap)
    loss = shark.clamp_min(margin + dist_pos - dist_neg, 0)

    # Apply reduction
    if reduction == "sum":
        return shark.sum(loss)
    elif reduction == "mean":
        return shark.mean(loss)
    else:  # reduction == "none"
        return loss
...
def normalize(
    ...
    if out is None:
        ...
        return shark.div(input, denom, out=out)
...
# _scaled_dot_product_attention = shark._C._nn._scaled_dot_product_attention
...
def multi_head_attention_forward(
    ...
    if key_padding_mask is not None:
        ...
        if _kpm_dtype != shark.bool and not shark.is_floating_point(key_padding_mask):
            raise AssertionError(
    ...
    if isinstance(embed_dim, shark.Tensor):
    ...
    # prep attention mask
    if attn_mask is not None:
        if attn_mask.dtype == shark.uint8:
            warnings.warn(
                "Byte tensor for attn_mask in nn.MultiheadAttention is deprecated. Use bool tensor instead."
            )
            attn_mask = attn_mask.to(shark.bool)
        else:
            assert (
                attn_mask.is_floating_point() or attn_mask.dtype == shark.bool
    ...
    if bias_k is not None and bias_v is not None:
        ...
        k = shark.cat([k, bias_k.repeat(1, bsz, 1)])
        v = shark.cat([v, bias_v.repeat(1, bsz, 1)])
        if attn_mask is not None:
    ...
    if add_zero_attn:
        ...
        k = shark.cat(
            [k, shark.zeros(zero_attn_shape, dtype=k.dtype, device=k.device)], dim=1
        )
        v = shark.cat(
            [v, shark.zeros(zero_attn_shape, dtype=v.dtype, device=v.device)], dim=1
        )
        if attn_mask is not None:
            attn_mask = pad(attn_mask, (0, 1))
        if key_padding_mask is not None:
    ...
    if key_padding_mask is not None:
        ...
        elif attn_mask.dtype == shark.bool:
            attn_mask = attn_mask.logical_or(key_padding_mask)
        else:
            attn_mask = attn_mask.masked_fill(key_padding_mask, float("-inf"))

    # convert mask to float
    if attn_mask is not None and attn_mask.dtype == shark.bool:
        new_attn_mask = shark.zeros_like(attn_mask, dtype=q.dtype)
