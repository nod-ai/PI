"""Implementations of Python fundamental objects for shark.compiler.byte_code_interpreter."""
import inspect
import linecache
import types
...
import six
from xdis import CO_GENERATOR, iscode
