...
c.def("__rtruediv__", [](PyAnyTorchTensorValue& self, py::args args, py::kwargs kwargs) { throw NotImplementedError("NotImplementedError: __rtruediv__ with signature __rtruediv__(self, other Any) -> Tensor"); });
...
c.def("__truediv__", [](PyAnyTorchTensorValue& self, py::args args, py::kwargs kwargs) { throw NotImplementedError("NotImplementedError: __truediv__ with signature __truediv__(self, other Any) -> Tensor"); });
...
c.def("chunk", [](PyAnyTorchTensorValue& self, py::args args, py::kwargs kwargs) { throw NotImplementedError("NotImplementedError: chunk with signature chunk(self, chunks _int, dim _int=0) -> List[Tensor]"); });
...
c.def("cuda", [](PyAnyTorchTensorValue& self, py::args args, py::kwargs kwargs) { throw NotImplementedError("NotImplementedError: cuda with signature cuda(self, device Optional[Union[_device, _int, str]]=None, non_blocking _bool=False) -> Tensor"); });
...
// isnan(self) -> Tensor
c.def("isnan", [](PyAnyTorchTensorValue& self, py::args args, py::kwargs kwargs) { throw NotImplementedError("NotImplementedError: isnan with signature isnan(self) -> Tensor"); });
...
c.def("scatter_", [](PyAnyTorchTensorValue& self, py::args args, py::kwargs kwargs) { throw NotImplementedError("NotImplementedError: scatter_ with signature @overload scatter_(self, dim _int, index Tensor, src Tensor) -> Tensor"); });

// @overload scatter_(self, dim _int, index Tensor, src Tensor, *, reduce str) -> Tensor
c.def("scatter_", [](PyAnyTorchTensorValue& self, py::args args, py::kwargs kwargs) { throw NotImplementedError("NotImplementedError: scatter_ with signature @overload scatter_(self, dim _int, index Tensor, src Tensor, *, reduce str) -> Tensor"); });

// @overload scatter_(self, dim _int, index Tensor, value Union[Number, _complex], *, reduce str) -> Tensor
c.def("scatter_", [](PyAnyTorchTensorValue& self, py::args args, py::kwargs kwargs) { throw NotImplementedError("NotImplementedError: scatter_ with signature @overload scatter_(self, dim _int, index Tensor, value Union[Number, _complex], *, reduce str) -> Tensor"); });

// @overload scatter_(self, dim _int, index Tensor, value Union[Number, _complex]) -> Tensor
c.def("scatter_", [](PyAnyTorchTensorValue& self, py::args args, py::kwargs kwargs) { throw NotImplementedError("NotImplementedError: scatter_ with signature @overload scatter_(self, dim _int, index Tensor, value Union[Number, _complex]) -> Tensor"); });
...
// sign(self) -> Tensor
c.def("sign", [](PyAnyTorchTensorValue& self, py::args args, py::kwargs kwargs) { throw NotImplementedError("NotImplementedError: sign with signature sign(self) -> Tensor"); });

// sign_(self) -> Tensor
c.def("sign_", [](PyAnyTorchTensorValue& self, py::args args, py::kwargs kwargs) { throw NotImplementedError("NotImplementedError: sign_ with signature sign_(self) -> Tensor"); });
...
c.def("split", [](PyAnyTorchTensorValue& self, py::args args, py::kwargs kwargs) { throw NotImplementedError("NotImplementedError: split with signature @overload split(self, split_size _int, dim _int=0) -> Sequence[Tensor]"); });

// @overload split(self, split_size Tuple[_int, ], dim _int=0) -> Sequence[Tensor]
c.def("split", [](PyAnyTorchTensorValue& self, py::args args, py::kwargs kwargs) { throw NotImplementedError("NotImplementedError: split with signature @overload split(self, split_size Tuple[_int, ], dim _int=0) -> Sequence[Tensor]"); });
...
c.def("tril", [](PyAnyTorchTensorValue& self, py::args args, py::kwargs kwargs) { throw NotImplementedError("NotImplementedError: tril with signature tril(self, diagonal _int=0) -> Tensor"); });

// tril_(self, diagonal _int=0) -> Tensor
c.def("tril_", [](PyAnyTorchTensorValue& self, py::args args, py::kwargs kwargs) { throw NotImplementedError("NotImplementedError: tril_ with signature tril_(self, diagonal _int=0) -> Tensor"); });
