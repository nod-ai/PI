...
namespace {
struct MungeCallingConventions
    : public PassWrapper<MungeCallingConventions, OperationPass<mlir::ModuleOp>> {
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(MungeCallingConventions)

  MungeCallingConventions() = default;
  MungeCallingConventions(const MungeCallingConventions &) {}
  StringRef getArgument() const override { return "refback-munge-calling-conventions"; }
...
mlir::python::createMungeCallingConventionsPass() {
...
struct ExpandOpsForLLVM : public PassWrapper<ExpandOpsForLLVM, OperationPass<func::FuncOp>> {
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(ExpandOpsForLLVM)

  ExpandOpsForLLVM() = default;
  ExpandOpsForLLVM(const ExpandOpsForLLVM &) {}
  StringRef getArgument() const override { return "refback-expand-ops-for-llvm"; }
...
mlir::python::createExpandOpsForLLVMPass() {
...
Operation *createLinalgCopyOp(OpBuilder &b, Location loc, Value from,
  ...
  (void) memrefTypeFrom;
  assert(memrefTypeFrom && memrefTypeTo && memrefTypeFrom.getRank() == memrefTypeTo.getRank());
  AffineMap id =
...
struct MungeMemrefCopy : public PassWrapper<MungeMemrefCopy, OperationPass<func::FuncOp>> {
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(MungeMemrefCopy)

  MungeMemrefCopy() = default;
  MungeMemrefCopy(const MungeMemrefCopy &) {}
  StringRef getArgument() const override { return "refback-munge-memref-copy"; }
...
std::unique_ptr<OperationPass<func::FuncOp>>
mlir::python::createMungeMemrefCopyPass() {
