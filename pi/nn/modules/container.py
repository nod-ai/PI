...
class ParameterList(Module):
    ...
    def __setitem__(self, idx: int, param: Any) -> None:
        ...
        idx = self._get_abs_string_index(idx)
        if isinstance(param, pi.Tensor) and not isinstance(param, Parameter):
            param = param
...
class ParameterDict(Module):
    ...
    def __setitem__(self, key: str, value: Any) -> None:
        ...
        self._keys[key] = None
        attr = self._key_to_attr(key)
        if isinstance(value, pi.Tensor) and not isinstance(value, Parameter):
            value = value
    ...
    def copy(self) -> "ParameterDict":
        """Returns a copy of this :class:`~pi.nn.ParameterDict` instance."""
