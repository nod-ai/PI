...
from shark.compiler.byte_code_interpreter.vm import (
    format_instruction,
    PyVM,
)
...
from shark.compiler.byte_code_interpreter.pyobj import traceback_from_frame
...
class PyVMTraced(PyVM):
    ...
    def eval_frame(self, frame):
        ...
        if frame.f_lasti == -1:
            ...
            byte_code = frame.f_code.co_code[frame.f_lasti]
            self.push_frame(frame)
        ...
        while True:
            ...
            if log.isEnabledFor(logging.INFO):
                self.log(byte_name, int_arg, arguments, opoffset, line_number)
            ...
            # are doing it.
            why = self.dispatch(byte_name, int_arg, arguments, opoffset, line_number)
