...
class _OpNamespace(types.ModuleType):
    def __init__(self, name):
        super(_OpNamespace, self).__init__("shark." + name)
        self.name = name
        self._dir = []
    ...
    def __call__(self, *args, **kwargs):
        ...
        # try:
        #     op, overload_names = shark._C._jit_get_operation(qualified_op_name)
        ...
        # shark.jit._builtins._register_builtin(op, qualified_op_name)
...
#     def __init__(self):
#         super(_PyOpNamespace, self).__init__("shark.ops")
