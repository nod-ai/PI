...
from shark.compiler.byte_code_interpreter.pyobj import Function, Cell, make_cell
...
def build_class(opc, func, name, *bases, **kwds):
    ...
    # If metaclass is builtin "type", it can't deal with a shark.compiler.byte_code_interpreter.pyobj.Cell object
