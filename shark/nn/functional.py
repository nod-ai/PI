...
import shark.mlir_wrappers as _VF
...
avg_pool2d = shark.nn.avg_pool2d
...
def max_pool2d_with_indices(
    ...
    return shark.nn.max_pool2d_with_indices(
        input, kernel_size, stride, padding, dilation, ceil_mode
    )
...
def adaptive_avg_pool2d(input: Tensor, output_size: BroadcastingList2[int]) -> Tensor:
    ...
    return shark.nn.adaptive_avg_pool2d(input, _output_size)
...
def hardtanh(
    ...
    if inplace:
        result = shark.nn.hardtanh_(input, min_val, max_val)
    else:
        result = shark.nn.hardtanh(input, min_val, max_val)
    return result


hardtanh_ = shark.nn.hardtanh_


def relu6(input: Tensor, inplace: bool = False) -> Tensor:
    if inplace:
        result = shark.nn.relu6_(input)
    else:
        result = shark.nn.relu6(input)
    return result
...
def leaky_relu(
    ...
    if inplace:
        result = shark.nn.leaky_relu_(input, negative_slope)
    else:
        result = shark.nn.leaky_relu(input, negative_slope)
    return result


leaky_relu_ = shark.nn.leaky_relu_
...
def hardswish(input: Tensor, inplace: bool = False) -> Tensor:
    if inplace:
        return shark.nn.hardswish_(input)
    return shark.nn.hardswish(input)
