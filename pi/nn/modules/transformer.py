...
class TransformerEncoder(Module):
    ...
    def forward(
        ...
        if src_key_padding_mask is not None:
            ...
            if _skpm_dtype != pi.bool and not pi.is_floating_point(
        ...
        if not isinstance(first_layer, pi.nn.TransformerEncoderLayer):
            why_not_sparsity_fast_path = (
        ...
        ) and not pi._nested_tensor_from_mask_left_aligned(
        ...
        if not why_not_sparsity_fast_path:
            ...
            elif pi.is_grad_enabled() and any(x.requires_grad for x in tensor_args):
                why_not_sparsity_fast_path = (
            ...
            if (not why_not_sparsity_fast_path) and (src_key_padding_mask is not None):
                ...
                output = pi._nested_tensor_from_mask(
...
class TransformerEncoderLayer(Module):
    ...
    def __init__(
        ...
        if activation is F.relu or isinstance(activation, pi.nn.ReLU):
            self.activation_relu_or_gelu = 1
        elif activation is F.gelu or isinstance(activation, pi.nn.GELU):
    ...
    def forward(
        ...
        if not why_not_sparsity_fast_path:
            ...
            if not why_not_sparsity_fast_path:
                ...
                return pi._transformer_encoder_layer_fwd(
                    src,
